...
public class Menu {
    ...
    public static void main(String[] args) {
        ru.job4j.gc.prof.Data store = new ru.job4j.gc.prof.RandomArray(new Random());
        Sort merge = new ru.job4j.gc.prof.MergeSort();
        Sort bubble = new BubbleSort();
        Sort insert = new ru.job4j.gc.prof.InsertSort();
